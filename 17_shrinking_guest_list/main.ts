...
let changingGuestList: string[] = ["Broad", "Natasha", "Whistle", "Stuart", "Paul", "Russel"];

let haveSpaceForTwoGuests: string = "The big dinner table is not arrived in time, i have a small dinner table with the space for two guests, therefore i can only invite two guests";
console.log(haveSpaceForTwoGuests);



//  letting guests know that they are not being invite
let popName = changingGuestList.pop();
console.log(`${popName}, I am sorry i cannot invite you on Dinner`);

let popName2 = changingGuestList.pop();
console.log(`${popName2}, I am sorry i cannot invite you on Dinner`);

let popName3 = changingGuestList.pop();
console.log(`${popName3}, I am sorry i cannot invite you on Dinner`);

let popName4 = changingGuestList.pop();
console.log(`${popName4}, I am sorry i cannot invite you on Dinner`);



// letting remaining guests know that they are still invited
let remainingOne = changingGuestList[1];
console.log(remainingOne + "," + " " + "You are still invited");

let remainingTwo = changingGuestList[0];
