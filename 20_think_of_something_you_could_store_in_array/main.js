...
var ListOf_citisOf_USA = ["San Fransisco", "New York", "Chicago", "Miami", "Las Vegas", "Houston", "Washington", "Loss Angelos", "New Orleans", "New Jersey"];
console.log("List of cities of USA");
console.log(ListOf_citisOf_USA);
